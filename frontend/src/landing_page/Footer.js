...
function Footer() {
    return (
        <footer style={{backgroundColor:"#fcfcf7"}}>
        <div className="container border-top mt-5" >
            <div className="row mt-5">
                <div className="col">
                    <img src="media/images/logo.svg" style={{ width: "50%" }} />
                    <p className="mt-3 text-muted" style={{fontSize:"0.87rem"}}>&copy; 2010 - 2025, Zerodha Broking Ltd. All rights reserved.</p>
                    <p class="d-flex justify-content-between text-muted " style={{ fontSize: "1.5rem", paddingRight:"2rem", marginRight:"2rem" }}>
                    ...
                    <p style={{fontSize:"1.5rem"}} className="text-muted">
                        <i class="fa fa-whatsapp pr-3" aria-hidden="true"></i>
                        <i class="fa fa-telegram px-3" aria-hidden="true"></i>
                        <i class="fa fa-youtube-play pl-3" aria-hidden="true"></i>
                    </p>
                </div>
                <div className="col">
                    <h5>Accout</h5>
                ...
                <div className="col">
                    <h5>Quik Links</h5>
                    <a href=""className="text-decoration-none text-muted">Upcoming IPOs </a>
                    <br />
                    <a href=""className="text-decoration-none text-muted">Brokerage charges </a>
                    <br />
                    <a href=""className="text-decoration-none text-muted">Market holidays </a>
                    <br />
                    <a href=""className="text-decoration-none text-muted">Economic calendar </a>
                    <br />
                    <a href=""className="text-decoration-none text-muted">Calculators </a>
                    <br />
                    <a href=""className="text-decoration-none text-muted">Markets </a>
                    <br />
                    <a href=""className="text-decoration-none text-muted">Sectors </a>
                </div>
            ...
            <div className="mt-5 text-muted" style={{ fontSize: "0.8rem" }}>
                ...
                <p class="d-flex justify-content-between px-5 mx-5">
                    <span className="">NSE</span> <span>BSE</span> <span>MCX</span> <span>Terms & conditions</span> <span>Policies & procedures</span> <span>Privacy policy</span> <span>Disclosure</span> <span>For investor's attention</span> <span>Investor charter</span>
                </p>
